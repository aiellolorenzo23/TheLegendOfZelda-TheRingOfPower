...
import static legend.zelda.The.Legend.of.Zelda.The.Ring.of.Power.Live.enums.EntityType.EXIT;

public class TheHero extends Creature{
    Item holdingItem;
    int lifePoints = 3;

    public TheHero(EntityType type, String name, String description, Room location, int lifePoints) {
        super(type, name, description, location);
        this.holdingItem = null;
        this.lifePoints = lifePoints;
    }

    public TheHero(String name, String description, Room location, int lifePoints) {
        this.name = name;
